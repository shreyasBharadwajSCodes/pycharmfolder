...
class CustomSmartGridEnv:
    ...
    def _calculate_market_reward(self, market_action_value):
        ...
        print(f"Market Reward: {market_reward}")
...
# Train the agents
train_ppo(env, battery_agent, solar_agent, chp_market_agent, num_episodes, max_timesteps)
